...
const CONTENT_TOP_OFFSET = DRAG_BAR_HEIGHT;
...
const VIEW_STORAGE_KEY = "cc-aitools-last-view";
    ...
    >
      ...
      <div className="flex-1 flex w-full h-full overflow-hidden">
          ...
          <div className="shrink-0 p-3 border-t space-y-2">
            ...
            <div className="flex items-center justify-center gap-1">
              <Button
                ...
                title={t("settings.themeLight", { defaultValue: "浅色" })}
              >
              ...
              <Button
                ...
                title={t("settings.themeDark", { defaultValue: "深色" })}
              >
              ...
              <Button
                ...
                title={t("settings.themeSystem", { defaultValue: "跟随系统" })}
              >
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 px-3 py-2 rounded-lg text-sm font-medium text-muted-foreground hover:text-foreground hover:bg-accent transition-all duration-200"
            >
              <svg
        ...
        <div className="h-full overflow-hidden flex-1">
          <main className="flex-1 h-full flex flex-col overflow-y-auto overflow-x-hidden animate-fade-in">
            {/* 顶部导航菜单栏 */}
            <div className="flex items-center justify-center px-6 py-3 shrink-0 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
              <NavigationSidebar
