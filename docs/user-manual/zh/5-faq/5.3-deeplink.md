...
CC AITools 支持 `ccswitch://` 深度链接协议，可以通过链接一键导入配置。
...
CC AITools 提供在线深度链接生成工具：

**访问地址**：[https://BluerAngala.github.io/cc-aitools/deplink.html](https://BluerAngala.github.io/cc-aitools/deplink.html)
...
使用 CC AITools 官方提供的在线深度链接生成工具更方便。
...
CC AITools 安装时会自动注册 `ccswitch://` 协议。
