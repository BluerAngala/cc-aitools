...
When enabling an app's toggle, CC AITools will:
...
When disabling an app's toggle, CC AITools will:
...
If you have already configured MCP servers in CLI tools, you can import them into CC AITools:

1. Click the "Import" button
2. Select the app to import from (Claude/Codex/Gemini/OpenCode)
3. CC AITools reads the existing configuration and imports it
