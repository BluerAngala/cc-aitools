...
CC AITools provides rich icon customization features:
...
This ensures CC AITools and CLI tool configurations stay in sync.
...
When adding a provider, CC AITools automatically extracts endpoint URLs from the configuration.
