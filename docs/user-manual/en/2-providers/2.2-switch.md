...
2. CC AITools updates the configuration file
...
1. Right-click the CC AITools icon in the system tray
...
When switching providers, CC AITools modifies the following files:
