...
sequenceDiagram
    ...
    participant Proxy as Local Proxy (CC AITools)
...
After starting the proxy and enabling app takeover, CC AITools modifies app configurations:
...
When stopping the proxy, CC AITools will:
