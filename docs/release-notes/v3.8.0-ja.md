...
CC AITools v3.8.0 はデータ永続化レイヤーと UI を大幅に作り替え、今後のクラウド同期やローカルプロキシ機能に向けた基盤を整えたメジャーアップデートです。
...
[Releases](https://github.com/BluerAngala/cc-aitools/releases/latest) から入手:
...
- [@BluerAngala](https://github.com/BluerAngala) - バグ修正と機能拡張
...
[登録時に「cc-aitools」で 10% オフ](https://www.packyapi.com/register?aff=cc-aitools)
...
- **Issue**: [GitHub Issues](https://github.com/BluerAngala/cc-aitools/issues)
