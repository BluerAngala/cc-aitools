...
- **ArchLinux 安装支持** (#259)
  添加 AUR 安装方式：`paru -S cc-aitools-bin`
...
访问 [Releases](https://github.com/BluerAngala/cc-aitools/releases/latest) 下载最新版本
...
访问 [Releases](https://github.com/BluerAngala/cc-aitools/releases/latest) 下载：
...
- [@BluerAngala](https://github.com/BluerAngala) - 从开发沦为 issue 回复机
- 社区成员的测试和反馈
...
[使用 "cc-aitools" 优惠码注册享 9 折优惠](https://www.packyapi.com/register?aff=cc-aitools)
...
- **问题反馈**：[GitHub Issues](https://github.com/BluerAngala/cc-aitools/issues)
- **讨论**：[GitHub Discussions](https://github.com/BluerAngala/cc-aitools/discussions)
