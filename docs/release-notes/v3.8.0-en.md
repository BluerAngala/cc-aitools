...
CC AITools v3.8.0 is a major architectural upgrade that restructures the data persistence layer and user interface, laying the foundation for future cloud sync and local proxy features.
...
- [@BluerAngala](https://github.com/BluerAngala) - Bug fixes and feature enhancements
...
[Use code "cc-aitools" for 10% off registration](https://www.packyapi.com/register?aff=cc-aitools)
...
- **Issue Reports**: [GitHub Issues](https://github.com/BluerAngala/cc-aitools/issues)
