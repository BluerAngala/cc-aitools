...
- **ArchLinux Installation Support** (#259)
  Added AUR installation method: `paru -S cc-aitools-bin`
...
Visit [Releases](https://github.com/BluerAngala/cc-aitools/releases/latest) to download the latest version
...
v3.7.0 represents a shift in CC AITools's positioning:
...
- [@BluerAngala](https://github.com/BluerAngala) - From developer to issue responder
...
[Register with "cc-aitools" code for 10% discount](https://www.packyapi.com/register?aff=cc-aitools)
...
- **Issues**: [GitHub Issues](https://github.com/BluerAngala/cc-aitools/issues)
- **Discussions**: [GitHub Discussions](https://github.com/BluerAngala/cc-aitools/discussions)
